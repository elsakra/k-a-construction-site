...
"locations": {
"k-a-construction-denver.md": {
	id: "k-a-construction-denver.md";
  slug: "k-a-construction-denver";
  body: string;
...
"services": {
"decks-pergolas-patios.md": {
	id: "decks-pergolas-patios.md";
  slug: "decks-pergolas-patios";
  body: string;
  collection: "services";
  data: InferEntrySchema<"services">
} & { render(): Render[".md"] };
"subcontractor-services.md": {
	id: "subcontractor-services.md";
  slug: "subcontractor-services";
  body: string;
  collection: "services";
  data: InferEntrySchema<"services">
} & { render(): Render[".md"] };
